...
//uint16_t cls0 = 0, cls1 = 0, cls2, cls3, cls4, cls5, cls6, cls7, cls8, cls9, cls10, cls11, cls12, cls13, cls14, cls15 = 0;
...
//if (sub>10) printf("sub is %u with pixelCounter=%u\n", sub, pixelCounter);
